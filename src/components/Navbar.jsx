...
console.log(menu);
  ...
  return (
    <div className="flex flex-row w-screen h-16 bg-rose-100 justify-between items-center fixed z-50 ">
       <div className="ml-5 md:hidden lg:hidden xl:hidden 2xl:hidden">
